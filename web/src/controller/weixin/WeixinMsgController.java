...
//	 */
	protected void processInTextMsg(InTextMsg inTextMsg) {
		...
		// 图文消息测试
            ...
            //System.out.print(AccessTokenApi.getAccessTokenStr());
            //System.out.print(CallbackIpApi.getCallbackIp());
		...
		// 其它文本消息直接返回原值 + 帮助提示
        else if ("报名".equals(msgContent)){
            OutNewsMsg outMsg = new OutNewsMsg(inTextMsg);
            outMsg.addNews("中外文化大赛火热开赛", "请大力戳我进行报名", "https://mmbiz.qlogo.cn/mmbiz/KJoUl0sqZFRHa3VrmibqAXRfYPNdiamFnpPTOvXoxsFlRoOHbVibGhmHOEUQiboD3qXWszKuzWpibFxsVW1RmNB9hPw/0?wx_fmt=jpeg","http://182.254.218.30/");
            render(outMsg);
        }
		else {
